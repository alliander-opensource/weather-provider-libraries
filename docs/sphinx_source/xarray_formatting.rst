...
for one weather factor to be dependent on a lat/lon location and time alone, whereas another may also be dependent on
...
This document will show you how to load the most common meteorological dataset formats into a xarray dataset and how to
