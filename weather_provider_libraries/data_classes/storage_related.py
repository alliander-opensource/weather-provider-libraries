...
from weather_provider_libraries.transformers.string_transformers import parse_bytesize_to_easily_readable
...
class StorageConfiguration(BaseModel):
    ...
    cache_size_in_mb: int = Field(
        default=0, title="Storage Cache Size", 
    ...
    period_to_archive: TimePeriod | None = Field(
        default=None, title="Storage Archival Period", 
    ...
    cache_to_archive: bool = Field(
        default=True, title="Storage Cache to Archive Mode", 
    ...
    def metadata(self) -> dict[str, str]:
        ...
        metadata_dict = {
            "Storage Mode": self.storage_mode
        }
